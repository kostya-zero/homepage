    ...
    <>
      <Container justifyContent="left" maxW={650} marginLeft="auto" marginRight="auto">
        ...
        <Box margin="15px" marginTop="20px">
          <HStack flex={1}>
            <Heading fontSize="5xl" fontWeight={700} textDecoration="underline">Contacts.</Heading>
          </HStack>
        </Box>
        <Box margin="15px" marginTop="20px" >
          <HStack flex={1}>
          ...
          <SocialCard url="mailto:zero@kostyazero.com" tooltip="mailto:zero@kostyazero.com" social="zero@kostyazero.com" icon={<FaMailBulk />} />
        </Box>
